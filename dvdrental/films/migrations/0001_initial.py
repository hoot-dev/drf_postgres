    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='films.language')),
            ],
            options={
                'db_table': 'film',
            },
        ...
        migrations.CreateModel(
            name='FilmActor',
            fields=[
                ('actor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='films.actor')),
                ('last_update', models.DateTimeField()),
